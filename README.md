...
| Training;  Programming model                                 | 10   | Cambricon-F\_ machine learning computers with fractal von neumann architecture <br>[summary](Summarys/2019/Cambricon-F Machine Learning Computers with Fractal von Neumann Architecture.docx) | Yongwei Zhao; Yunji Chen                            | ICT; Cambricon                                               |
| Tags                                                         | 11   | Master of none acceleration\_ a comparison of accelerator architectures for analytical query processing <br>[summary](Summarys/2019/Master of None Acceleration A Comparison of Accelerator Architectures for Analytical Query Processing.docx) | Andrea Lottarini; Martha A. Kim                     | Google; Columbia University                                  |
<br>
...
| Tags                                           | - | Title                                                                                                                                                                                                                                          | Authors                               | Affiliations                                                         |
|------------------------------------------------|----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|----------------------------------------------------------------------|
| Training;CNN; RNN                              | 1  | A Configurable Cloud-Scale DNN Processor for Real-Time AI <br>[summary](Summarys/2018/A Configurable Cloud-Scale DNN Processor for Real-Time AI.docx) | Jeremy Fowers; Doug Burger            | Microsoft                                                            |
